    ...
    <div className="mainText">
      ...
      <div className="infoTextDiv">
        <ol className="ol-class">
          <li>
            <a target="__blank" href="https://github.com/datomaluta/omnifood">
              Omnifood Responsive Website - Git
            </a>
          </li>

          <li>
            <a target="__blank" href="https://maliafood.netlify.app/">
              Omnifood Responsive Website - netlify
            </a>
          </li>
          ...
          <li>
            <a
              target="__blank"
              href="https://github.com/datomaluta/bankist-account"
            >
              Bankist app - Git
            </a>
          </li>
          ...
          <li>
            <a
              target="__blank"
              href="https://euphonious-gumdrop-d9c5a8.netlify.app/"
            >
              Bankist app - netlify - user: js, pass: 1111
            </a>
          </li>
          ...
          <li>
            <a
              target="__blank"
              href="https://github.com/datomaluta/bankist-business"
            >
              Bankist Website - Git
            </a>
          </li>
          ...
          <li>
            <a
              target="__blank"
              href="https://dulcet-sundae-964d94.netlify.app/"
            >
              Bankist Website - netlify
            </a>
          </li>
